...
<div class=" d-flex">
    ...
    <div class="col-10 border">
        <h4 class="">Quản lý thương hiệu </h4>
        <div class="border border-dark rounded  m-3 p-3 ">
            <h5>Thêm thương hiệu</h5>
            <div class="col-md-3">
                <div class="input-group mb-3">
                    <input type="text" name="ten" class="form-control" placeholder="Tên thương hiệu" aria-label="Recipient's username" aria-describedby="button-addon2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <div class="mb-3">
                        <label class="col-form-label">Tên thương hiệu:</label>
...
<script defer>
    ...
    function addData(data) {
        ...
        fetch('http://localhost:8080/thuonghieu/api/add', options)
    ...
    function udateData(id,data){
        ...
        fetch('http://localhost:8080/thuonghieu/api/update/'+id, options)
            .then(function (response) {
                response.json();
    ...
    function detailData(id) {
        ...
        fetch('http://localhost:8080/thuonghieu/api/detail/' + id)
            .then(function (response) {
