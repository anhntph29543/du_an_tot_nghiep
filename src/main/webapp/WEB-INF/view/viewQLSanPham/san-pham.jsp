...
<%--        //Danh sach san pham --%>
        <div class="  my-3 ">
            ...
            <div class="border border-dark rounded  mx-3  " style="height: 330px">
                <div class=" mt-2 mx-3 d-flex justify-content-end">
                    <a class="btn btn-dark btn-sm mx-2" href="them-san-pham" role="button">Thêm sản phẩm </a>
                    <a class="btn btn-dark btn-sm " href="san-pham-chi-tiet" role="button">Sản phảm chi tiết  </a>
                </div>
