...
<div class=" d-flex">
    ...
    <div class="col-10 border">
        <h4 class="">Quản lý màu sắc </h4>
        <div class="border border-dark rounded  m-3 p-3 ">
            <h5>Thêm màu sắc </h5>
            <div class="col-md-3">
                <div class="input-group mb-3">
                    <input type="text" name="ten" class="form-control" placeholder="Tên màu sắc " aria-label="Recipient's username" aria-describedby="button-addon2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <div class="mb-3">
                        <label class="col-form-label">Tên màu sắc:</label>
...
<script defer>
    ...
    const clModal= new bootstrap.Modal('#mauSac');
    function start() {
        getData();
    }
    ...
    function addData(data) {
        ...
        fetch('http://localhost:8080/MauSac/api/add', options)
    ...
    function udateData(id,data){
        ...
        fetch('http://localhost:8080/MauSac/api/update/'+id, options)
            .then(function (response) {
                response.json();
    ...
    function detailData(id) {
        ...
        fetch('http://localhost:8080/MauSac/api/detail/' + id)
            .then(function (response) {
                        ...
                        "columns": [
                            ...
                            },
                            {
                                ...
                                "render": function (data, type, row, meta) {
                                    ...
                                    return '<button  type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#mauSac" onclick="detailData(`'+data+'`)" ><i class="bi bi-pencil-square"></i></button >';
                                }
